 ...
 *
 * This constructor creates an instance of Middle-Earth with num_cities cities
 * with distances randomly determined, but still dependent upon xsize and ysize.
 * @param xsize Used to determine distance in x-direction.
 * @param ysize Used to determine distance in y-direction.
 * @param num_cities This is the number of cities to be created.
...
/** @brief prints a tab-separated table of the distances (this can be loaded
